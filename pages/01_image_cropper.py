...
max_height = img_arr.shape[0]
   # TODO: Replace None with the maximum height of the image using np.shape() function
...
# Optional: check the shape of the cropped image
print("Original shape:", img_arr.shape)
print("Cropped shape:", crop_arr.shape)
